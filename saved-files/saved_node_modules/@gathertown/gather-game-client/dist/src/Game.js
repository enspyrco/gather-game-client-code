...
class Game {
    ...
    sendAction(action, useTxn = false, txnTimeout) {
        var _a;
        return (_a = this.engine) === null || _a === void 0 ? void 0 : _a.sendAction(action, false, useTxn, undefined, txnTimeout);
    }
    ...
    setMapObjects(mapId, objects, updatesAreOverwrites) {
        ...
        Object.entries(objects).reduce((wireObjects, [keyString, obj]) => {
            ...
            wireObjects[key] = (0, gameMap_1.convertMapObjectToWireObject)(obj);
            return wireObjects;
        }, wireObjects);
        (_a = this.engine) === null || _a === void 0 ? void 0 : _a.sendAction({
            $case: "mapSetObjects",
    ...
    setObject(mapId, objId, _obj, useTxnId = false, objectIdToPrependTo) {
        var _a, _b, _c, _d;
    ...
    requestAccessViaCheckIn(userId, canceled, name, outfitString) {
        var _a;
        (_a = this.engine) === null || _a === void 0 ? void 0 : _a.sendAction({
    ...
    EXPERIMENT_enterWithTeammatesSetOwnLobbyInfo(name, outfitString) {
        var _a;
        (_a = this.engine) === null || _a === void 0 ? void 0 : _a.sendAction({
    ...
    sendSubscribe() {
        const onSuccess = () => {
            ...
            (_a = this.engine) === null || _a === void 0 ? void 0 : _a.logInitialSyncComplete(isPartialSubscribe);
        };
        this.sendAction({
