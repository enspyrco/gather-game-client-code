...
import { Announcer, ChatMessageUpdated, DeskInfoV2, HipToBeSquare, MapAndDesk, NookDiff, PlayerInitInfo, Portal, RespondToAccessRequest_LocationTypeEnum, SpaceItem, SpawnPoint, SpeakerUpdatesSession, WireArea } from "@gathertown/gather-game-common/dist/src/public/events";
import { EnabledChat, MapObject, TutorialTasks } from "@gathertown/gather-game-common/dist/src/public/gameMap";
...
declare type EventSubscriptions = {
...
export declare class Game {
    ...
    sendAction2<TCase extends ClientServerActionCase>(actionId: TCase, actionData: ActionDataByCase<TCase>, useTxn: true): Promise<unknown>;
    sendAction2<TCase extends ClientServerActionCase>(actionId: TCase, actionData: ActionDataByCase<TCase>, useTxn?: boolean): Promise<unknown> | void;
    ...
    triggerItem(closestObject?: string, closestObjectTemplate?: string): void;
    setSpotlight(user: string, spotlighted: boolean): void;
    banPlayer(user: string): void;
    kickPlayer(user: string): void;
    interact(objId: string, mapId: string, data?: unknown): void;
    ...
    setObject(mapId: string, objId: string, _obj: Partial<MapObject>, useTxnId?: boolean, objectIdToPrependTo?: string): void | Promise<unknown>;
    ...
    requestAccessViaCheckIn(userId: string, canceled: boolean, name?: string, outfitString?: string): void;
    respondToAccessRequest(userId: string, accepted: boolean, locationType?: RespondToAccessRequest_LocationTypeEnum): void;
    EXPERIMENT_enterWithTeammatesInitiateEnterSpace(): void;
    EXPERIMENT_enterWithTeammatesSetOwnLobbyInfo(name: string, outfitString: string): void;
