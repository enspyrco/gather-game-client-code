...
exports.testWebsocketConnection = exports.testConnection = exports.parseCustomAction = exports.fetchGameServerAssignment = exports.SlidingWindow = void 0;
...
const fetchGameServerAssignment = (cancelToken, space, overrideHttpServer) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const res = yield axios_1.default.get(`${hostname}/api/v2/spaces/${encodeURIComponent(space)}/game-server-assignment`, { cancelToken });
        return res.data;
    }
    catch (e) {
...
const testConnection = (serverUrl, testId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const gsHttpUrl = serverUrl
        ...
        : null;
    const [googleResult, gatherResult, myGsResult] = yield Promise.all([
...
const testWebsocketConnection = (serverUrl, timeout = 45000) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve) => {
        const cleanupWs = (ws) => {
            ws.onopen = null;
            ws.onerror = null;
        };
        const onFailed = (error) => resolve({ success: false, error });
        try {
            const ws = new WebSocket(serverUrl, "gather-v2");
            ...
            ws.onerror = (e) => {
                try {
                    ...
                    onFailed(`ws error: ${Logger_1.logger.errString(e)}`);
                }
            };
        }
        catch (e) {
            onFailed(`ws exception: ${Logger_1.logger.errString(e)}`);
        }
    });
});
