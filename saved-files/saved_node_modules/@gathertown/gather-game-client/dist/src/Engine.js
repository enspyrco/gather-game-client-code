...
class Engine {
    ...
    cleanUpAndQueueReconnect(disconnectInfo) {
        ...
        this.onmetric("reconnect-attempt", Object.assign(Object.assign({}, this.getBaseMetricsInfo()), { attempts: this._reconnectionAttempts, serverUrl: this.serverURL, hasEverFullyConnected: this.hasEverFullyConnected, timeSinceLastSuccessfulFetch: Date.now() - this.lastSuccessfulFetch, timeSinceLastSignOfLife, timeSinceLastSuspend: Date.now() - this.lastSuspendDate, fastReconnect,
            reuseServerURL }));
