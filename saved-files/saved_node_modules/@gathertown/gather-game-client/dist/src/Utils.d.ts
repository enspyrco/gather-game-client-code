...
export declare const fetchGameServerAssignment: (cancelToken: CancelTokenSource["token"], space: string, overrideHttpServer?: string) => Promise<string>;
...
export declare const testWebsocketConnection: (serverUrl: string, timeout?: number) => Promise<{
    success: boolean;
    error?: string;
}>;
