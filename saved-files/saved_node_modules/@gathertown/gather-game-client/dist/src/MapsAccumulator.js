    ...
    addChunk(event) {
        ...
        switch (event.$case) {
            ...
            case "mapSetCollisions": {
                ...
                this.updateCollisions(mapId, offsetX, offsetY, w, h, maskBytes, false);
                break;
            }
            case "mapSetObjects": {
                ...
                for (const stringKey in wireObjects) {
                    ...
                    try {
                        const convertedWireObject = (0, gameMap_1.convertWireObjectToMapObjectPartial)(wireObjects[key], key);
                        const newObject = updatesAreOverwrites
                            ? convertedWireObject
                            : Object.assign(Object.assign({}, map.objects[key]), convertedWireObject);
