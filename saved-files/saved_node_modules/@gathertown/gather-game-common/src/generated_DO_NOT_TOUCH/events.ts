...
export interface EnterWithTeammatesLobbyStateUpdated {
  ...
  users: EnterWithTeammatesLobbyUser[];
}
...
export interface ServerClientEvent {
  event?:
    ...
    | {
      ...
      enterWithTeammatesLobbyStateUpdated: EnterWithTeammatesLobbyStateUpdated;
    }
    | {
      $case: "enterWithTeammatesHostInitiatesEnterSpace";
      enterWithTeammatesHostInitiatesEnterSpace: EnterWithTeammatesHostInitiatesEnterSpace;
    }
    | {
...
export interface ClientServerAction {
  ...
  action?:
    ...
    | {
      ...
      enterWithTeammatesSetOwnLobbyInfo: EnterWithTeammatesSetOwnLobbyInfo;
    }
    | {
      $case: "enterWithTeammatesInitiateEnterSpace";
      enterWithTeammatesInitiateEnterSpace: EnterWithTeammatesInitiateEnterSpace;
    }
...
export const MapSetObjects = {
  encode(message: MapSetObjects, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.objects).forEach(([key, value]) => {
      MapSetObjects_ObjectsEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).ldelim();
    });
...
export const EnterWithTeammatesLobbyStateUpdated = {
  encode(message: EnterWithTeammatesLobbyStateUpdated, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.users) {
      EnterWithTeammatesLobbyUser.encode(v!, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.users.push(EnterWithTeammatesLobbyUser.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  encode(message: ServerClientEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    switch (message.event?.$case) {
      ...
      case "playerSetsWorkCondition":
        PlayerSetsWorkCondition.encode(message.event.playerSetsWorkCondition, writer.uint32(130).fork()).ldelim();
        break;
      case "playerSetsName":
      ...
      case "playerSetsOutfitString":
        PlayerSetsOutfitString.encode(message.event.playerSetsOutfitString, writer.uint32(322).fork()).ldelim();
        break;
      ...
      case "playerSetsCurrentDesk":
        PlayerSetsCurrentDesk.encode(message.event.playerSetsCurrentDesk, writer.uint32(418).fork()).ldelim();
        break;
      ...
      case "playerTriggersItem":
        PlayerTriggersItem.encode(message.event.playerTriggersItem, writer.uint32(874).fork()).ldelim();
        break;
      ...
      case "playerUpdatesSession":
        PlayerUpdatesSession.encode(message.event.playerUpdatesSession, writer.uint32(930).fork()).ldelim();
        break;
      case "mapMoveObject":
      ...
      case "subscriptionsUpdated":
        ...
        break;
      case "enterWithTeammatesLobbyStateUpdated":
        EnterWithTeammatesLobbyStateUpdated.encode(
          message.event.enterWithTeammatesLobbyStateUpdated,
          writer.uint32(1298).fork(),
        ).ldelim();
        break;
      case "enterWithTeammatesHostInitiatesEnterSpace":
        EnterWithTeammatesHostInitiatesEnterSpace.encode(
          message.event.enterWithTeammatesHostInitiatesEnterSpace,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 61:
          ...
          break;
        case 62:
          message.event = { $case: "mapSetSprites", mapSetSprites: MapSetSprites.decode(reader, reader.uint32()) };
          break;
        case 63:
          message.event = { $case: "mapSetSpaces", mapSetSpaces: MapSetSpaces.decode(reader, reader.uint32()) };
          break;
        case 64:
        ...
        case 69:
          ...
          break;
        case 70:
          message.event = { $case: "mapSetObjects", mapSetObjects: MapSetObjects.decode(reader, reader.uint32()) };
          break;
        case 71:
        ...
        case 162:
          message.event = {
            $case: "enterWithTeammatesLobbyStateUpdated",
            enterWithTeammatesLobbyStateUpdated: EnterWithTeammatesLobbyStateUpdated.decode(reader, reader.uint32()),
          };
          break;
        case 163:
          message.event = {
            $case: "enterWithTeammatesHostInitiatesEnterSpace",
            enterWithTeammatesHostInitiatesEnterSpace: EnterWithTeammatesHostInitiatesEnterSpace.decode(
              reader,
              reader.uint32(),
            ),
          };
  ...
  encode(message: ClientServerAction, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    switch (message.action?.$case) {
      ...
      case "setSubtitle":
        ...
        break;
      case "playerUpdatesSession":
        PlayerUpdatesSession.encode(message.action.playerUpdatesSession, writer.uint32(730).fork()).ldelim();
        break;
      case "mapMoveObject":
      ...
      case "setAvailability":
        ...
        break;
      case "enterWithTeammatesSetOwnLobbyInfo":
        EnterWithTeammatesSetOwnLobbyInfo.encode(
          message.action.enterWithTeammatesSetOwnLobbyInfo,
          writer.uint32(1082).fork(),
        ).ldelim();
        break;
      case "enterWithTeammatesInitiateEnterSpace":
        EnterWithTeammatesInitiateEnterSpace.encode(
          message.action.enterWithTeammatesInitiateEnterSpace,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 15:
          ...
          break;
        case 18:
          message.action = { $case: "interact", interact: Interact.decode(reader, reader.uint32()) };
          break;
        case 19:
        ...
        case 38:
          ...
          break;
        case 39:
          message.action = { $case: "setCurrentDesk", setCurrentDesk: SetCurrentDesk.decode(reader, reader.uint32()) };
          break;
        case 40:
        ...
        case 41:
          ...
          break;
        case 42:
          message.action = { $case: "setGoKartId", setGoKartId: SetGoKartId.decode(reader, reader.uint32()) };
          break;
        case 43:
          message.action = {
            $case: "mapSetDimensions",
        ...
        case 46:
          ...
          break;
        case 47:
          message.action = { $case: "mapSetSprites", mapSetSprites: MapSetSprites.decode(reader, reader.uint32()) };
          break;
        case 48:
          message.action = { $case: "mapSetSpawns", mapSetSpawns: MapSetSpawns.decode(reader, reader.uint32()) };
          break;
        case 49:
          message.action = { $case: "mapSetSpaces", mapSetSpaces: MapSetSpaces.decode(reader, reader.uint32()) };
          break;
        case 50:
        ...
        case 54:
          ...
          break;
        case 55:
          message.action = { $case: "mapSetObjects", mapSetObjects: MapSetObjects.decode(reader, reader.uint32()) };
          break;
        case 56:
        ...
        case 83:
          ...
          break;
        case 84:
          message.action = { $case: "triggerItem", triggerItem: TriggerItem.decode(reader, reader.uint32()) };
          break;
        case 85:
        ...
        case 135:
          message.action = {
            $case: "enterWithTeammatesSetOwnLobbyInfo",
            enterWithTeammatesSetOwnLobbyInfo: EnterWithTeammatesSetOwnLobbyInfo.decode(reader, reader.uint32()),
          };
          break;
        case 136:
          message.action = {
            $case: "enterWithTeammatesInitiateEnterSpace",
            enterWithTeammatesInitiateEnterSpace: EnterWithTeammatesInitiateEnterSpace.decode(reader, reader.uint32()),
          };
          break;
        case 137:
