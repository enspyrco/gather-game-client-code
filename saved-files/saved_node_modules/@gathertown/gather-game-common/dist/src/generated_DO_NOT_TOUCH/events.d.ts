...
export declare const EnterWithTeammatesLobbyUser: {
    encode(message: EnterWithTeammatesLobbyUser, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EnterWithTeammatesLobbyUser;
};
export declare const EnterWithTeammatesLobbyStateUpdated: {
    encode(message: EnterWithTeammatesLobbyStateUpdated, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EnterWithTeammatesLobbyStateUpdated;
};
export declare const EnterWithTeammatesHostInitiatesEnterSpace: {
    encode(message: EnterWithTeammatesHostInitiatesEnterSpace, writer?: _m0.Writer): _m0.Writer;
...
export declare const EnterWithTeammatesSetOwnLobbyInfo: {
    encode(message: EnterWithTeammatesSetOwnLobbyInfo, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): EnterWithTeammatesSetOwnLobbyInfo;
};
export declare const EnterWithTeammatesInitiateEnterSpace: {
    encode(_: EnterWithTeammatesInitiateEnterSpace, writer?: _m0.Writer): _m0.Writer;
