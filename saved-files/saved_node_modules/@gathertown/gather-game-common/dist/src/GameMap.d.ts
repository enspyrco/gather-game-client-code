...
export interface GameMapHttpPublic extends Omit<GameMapDB, "typeCheckFakeField" | "typeCheckFakeField2" | "objects" | "spaces" | "desks"> {
    typeCheckFakeField?: never;
    typeCheckFakeField2?: null;
    objects?: Omit<MapObject, "zIndex">[];
    spaces?: Space[];
    desks?: Desks;
    occupiedNookTilesMap?: never;
}
export interface GameMapHttpPublicV2 extends Omit<GameMapDB, "typeCheckFakeField" | "typeCheckFakeField2"> {
    typeCheckFakeField?: never;
    typeCheckFakeField2?: null;
    occupiedNookTilesMap?: never;
}
...
declare type _WireMapObjectRequiredFieldsT = (typeof MapObjectRequiredFields)[number];
declare type _WireObjectWithRequireds = MakeFieldsRequired<WireObject, _WireMapObjectRequiredFieldsT>;
declare const NookRequiredFields: readonly ["nookCoords", "name"];
export declare type Nook = MakeFieldsRequired<NookDiff, (typeof NookRequiredFields)[number]>;
...
export declare type MapObjectToAdd = Omit<MapObject, "zIndex">;
...
export declare function convertWireObjectToMapObjectPartial(wireObject: WireObject, key: number): Partial<MapObject>;
...
export declare function convertCoordsToBBoxes(coords: Point[]): BoundingBox[];
...
export declare const objectsArrayToDict: (objects: NonNullable<GameMapHttpPublic["objects"]>) => NonNullable<GameMapDB["objects"]>;
export declare const objectsDictToArray: (objects: NonNullable<GameMapDB["objects"]>) => NonNullable<GameMapHttpPublic["objects"]>;
