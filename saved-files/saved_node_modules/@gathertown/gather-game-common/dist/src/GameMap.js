...
exports.objectsDictToArray = exports.objectsArrayToDict = exports.desksToNooks = exports.mergeNooks = exports.deprecatedSpacesToNooks = exports.nookToDeprecatedSpaces = exports.MAP_MAX_DIMENSION = exports.convertStringToPresetTutorialGroupSetId = exports.convertTutorialTasksToWireTutorialTasks = exports.convertWireTutorialTasksToTutorialTasks = exports.PresetTutorialGroupSetIds = exports.convertStringToEnabledChat = exports.EnabledChat = exports.coordsMapToPositions = exports.convertNookInfoToOccupiedNookTilesMap = exports.interactionOpensModal = exports.TileType = exports.convertCoordsToBBoxes = exports.convertDesksToDBDesks = exports.convertDBDesksToDesks = exports.generateEmptyDeskCoordsMap = exports.convertDBDesksCoordsToCoordsMap = exports.convertAreaCoordsToCoordsMap = exports.convertWireAreasToAreas = exports.convertWireAreasToDBAreas = exports.AreaCategory = exports.convertMapObjectToWireObject = exports.convertWireObjectToMapObjectPartial = exports.convertWireObjectToMapObjectDBPartial = exports.isMapObject = exports.isMapObjectDB = exports.findMissingMapObjectFields = exports.isNook = exports.isTileType = exports.WallFloorDB = exports.FloorBlock = exports.WallBlock = exports.Interaction = void 0;
...
exports.isMapObjectDB = isMapObjectDB;
function isMapObject(obj) {
    return MapObjectRequiredFields.every((field) => obj[field] != null);
}
exports.isMapObject = isMapObject;
function convertWireObjectToMapObjectDBPartial(wireObject) {
    return Object.assign(Object.assign({}, (0, lodash_1.cloneDeep)((0, ramda_1.omit)(["propertiesJson"], wireObject))), (wireObject.propertiesJson ? { properties: JSON.parse(wireObject.propertiesJson) } : {}));
}
exports.convertWireObjectToMapObjectDBPartial = convertWireObjectToMapObjectDBPartial;
function convertWireObjectToMapObjectPartial(wireObject, key) {
    const obj = convertWireObjectToMapObjectDBPartial(wireObject);
    obj.key = key;
    return obj;
}
exports.convertWireObjectToMapObjectPartial = convertWireObjectToMapObjectPartial;
function convertMapObjectToWireObject(mapObject) {
    return Object.assign(Object.assign({ _tags: [] }, (0, lodash_1.cloneDeep)((0, ramda_1.omit)(["properties"], mapObject))), (mapObject.properties ? { propertiesJson: JSON.stringify(mapObject.properties) } : {}));
}
...
(function (PresetTutorialGroupSetIds) {
    PresetTutorialGroupSetIds["UNUSED"] = "UNUSED";
...
const objectsArrayToDict = (objects) => {
    ...
    objects.forEach((obj, ind) => {
        objOut[(0, base64_1.numToBase64)(ind)] = Object.assign(Object.assign({}, obj), { zIndex: ind });
    });
    return objOut;
};
exports.objectsArrayToDict = objectsArrayToDict;
const objectsDictToArray = (objects) => Object.values(objects).sort((a, b) => a.zIndex - b.zIndex);
exports.objectsDictToArray = objectsDictToArray;
