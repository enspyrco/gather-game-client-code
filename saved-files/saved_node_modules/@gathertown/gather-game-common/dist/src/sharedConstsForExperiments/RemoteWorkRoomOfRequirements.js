...
exports.SocialRoomInfo = exports.HIP_TO_BE_SQUARE_MAP = exports.ActivityTimeFilterOptions = exports.ParticipantFilterOptions = exports.SocialRoomSize = exports.SocialRoom = exports.targetMaps = exports.isRoRActive = exports.isRorStandaloneObject = exports.isRorObject = exports.ROOM_DOOR_OBJECT_ID = exports.ROOM_CONTROLLER_OBJECT_ID = exports.ROOM_OF_REQUIREMENTS_EXTENSION = void 0;
exports.ROOM_OF_REQUIREMENTS_EXTENSION = "RemoteWorkRoomOfRequirements";
exports.ROOM_CONTROLLER_OBJECT_ID = "CyberpunkKioskWall - ja17fdCaXI-xbC9Imc0Rm_754e70d9-0b7b-4fc2-bebe-e2c1207c95d2";
exports.ROOM_DOOR_OBJECT_ID = "gBm9cPiE9ORWWatgyeC9_dedd43b1-6d34-4511-a92e-c5e019b8617a";
const isRorObject = (id) => id === exports.ROOM_CONTROLLER_OBJECT_ID || id.startsWith("RoomOfRequirements");
exports.isRorObject = isRorObject;
const isRorStandaloneObject = (id) => id.startsWith("RoomOfRequirementsStandalone");
exports.isRorStandaloneObject = isRorStandaloneObject;
const isRoRActive = (room) => room.rorActive;
exports.isRoRActive = isRoRActive;
...
var SocialRoom;
(function (SocialRoom) {
    SocialRoom["HipToBeSquare"] = "Hip to be Square";
    SocialRoom["GoKarts"] = "Grand Prix";
    SocialRoom["SpeedGathering"] = "Speed Gathering";
    SocialRoom["TetrisTournament"] = "Tetris Tourney";
    SocialRoom["Trivia"] = "Trivia";
    SocialRoom["Poker"] = "Poker Night";
    SocialRoom["TalentShow"] = "Talent Show";
    SocialRoom["OldPoker"] = "Poker";
    SocialRoom["OldGoKarts"] = "Go Karts";
    SocialRoom["BoardGames"] = "Board Game Night";
})(SocialRoom = exports.SocialRoom || (exports.SocialRoom = {}));
var SocialRoomSize;
(function (SocialRoomSize) {
    SocialRoomSize["Small"] = "Small (1 - 25 people)";
    SocialRoomSize["Medium"] = "Medium (25 - 50 people)";
    SocialRoomSize["Large"] = "Large (50 - 100 people)";
})(SocialRoomSize = exports.SocialRoomSize || (exports.SocialRoomSize = {}));
exports.ParticipantFilterOptions = ["2-10", "10-25", "25+"];
exports.ActivityTimeFilterOptions = ["under 30 mins", "30-60 mins", "60+ mins"];
exports.HIP_TO_BE_SQUARE_MAP = "hip-to-be-square";
exports.SocialRoomInfo = {
    [SocialRoom.HipToBeSquare]: {
        ...
        portal: {
            targetMap: exports.HIP_TO_BE_SQUARE_MAP,
            targetX: 2,
            targetY: 17,
        },
    ...
    [SocialRoom.GoKarts]: {
        ...
        guideURL: "https://support.gather.town/help/gather-grand-prix",
    ...
    [SocialRoom.SpeedGathering]: {
        ...
        guideURL: "https://support.gather.town/help/speed-gathering?utm_source=template&utm_medium=app&utm_campaign=experiences",
    ...
    [SocialRoom.TetrisTournament]: {
        ...
        guideURL: "https://support.gather.town/help/tetris-tourney?utm_source=template&utm_medium=app&utm_campaign=experiences",
    ...
    [SocialRoom.TalentShow]: {
        ...
        guideURL: "https://support.gather.town/help/talent-show",
