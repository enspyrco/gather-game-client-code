...
declare type GrandPrixMapsInfoType = {
    imageURL: string;
...
export declare type GrandPrixPlayer = {
    playerId: string;
    isSpectator: boolean;
...
export declare type GrandPrixPlayerFinishedRaceData = {
    [playerId: string]: GrandPrixPlayer;
};
export declare type GrandPrixAllPlayersFinishedData = GrandPrixPlayerFinishedRaceData;
export declare type GrandPrixPlayerReadyData = GrandPrixPlayer;
export declare type GrandPrixJoinSpaceData = {
    playerId: string;
};
export declare type GrandPrixEndRaceData = {
    isNextRace: boolean;
};
export declare type GrandPrixSelectTrackData = {
    selectedTrack: string;
    currentTrack: string;
};
export declare type GrandPrixLeaveData = GrandPrixPlayer;
