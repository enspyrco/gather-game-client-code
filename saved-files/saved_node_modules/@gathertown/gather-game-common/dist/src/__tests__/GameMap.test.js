...
const factories_1 = require("../public/factories");
const ramda_1 = require("ramda");
it("converts between wire objects and db objects consistently", () => {
    const firstWireObject = factories_1.factories.wireObject.build({
        propertiesJson: `{"url":"https://gather.town"}`,
    });
    const firstDbObject = (0, GameMap_1.convertWireObjectToMapObjectDBPartial)(firstWireObject);
    const secondWireObject = (0, GameMap_1.convertMapObjectToWireObject)(firstDbObject);
    const secondDbObject = (0, GameMap_1.convertWireObjectToMapObjectDBPartial)(secondWireObject);
...
it("converts objects to/from array/dict consistently", () => {
    const objectsArray1 = new Array(20).fill("").map(() => factories_1.factories.mapObjectDB.build());
    const objectsDict1 = (0, GameMap_1.objectsArrayToDict)(objectsArray1);
    const objectsArray2 = (0, GameMap_1.objectsDictToArray)(objectsDict1);
    const objectsDict2 = (0, GameMap_1.objectsArrayToDict)(objectsArray2);
    const withoutZIndex = (arr) => arr.map((o) => (0, ramda_1.omit)(["zIndex"], o));
...
describe("#convertWireAreasToDBAreas", () => {
    ...
    it("converts wire areas to a coords map", () => {
        ...
        const coordsMap = (0, GameMap_1.convertAreaCoordsToCoordsMap)(coords, [mapWidth, mapHeight]);
...
describe("#convertDBDesksCoordsToCoordsMap", () => {
    ...
    it("converts db desks to coords map, handles overlapping and clipping", () => {
        ...
        const coordsMap = (0, GameMap_1.convertDBDesksCoordsToCoordsMap)(dbDesks, [mapWidth, mapHeight]);
        expect(coordsMap).toEqual([
            ["", "", "", "", ""],
            ["", "desk1", "desk1", "desk1", ""],
            ["", "desk1", "desk1", "desk1", ""],
